...
//
// Everything here is deliberately generic. Hyperwake sells a computer, not a
...
// standard Hyperwake guest.
func NewProber() *Prober {
	return &Prober{
		DisplayAddr: envOr("HYPERWAKE_DISPLAY_ADDR", "127.0.0.1:5900"),
		SSHAddr:     envOr("HYPERWAKE_SSH_ADDR", "127.0.0.1:22"),
